        ...
        <div class="container is-max-desktop">
            ...
            <!-- <div class="columns is-flex is-justify-content-center">
                <div class="column is-6">
                    <div class="field">
                    <p class="control">
                    <label class="label">rendez-vous du patient</label>
                        <?php
                        if ($listRdvInPatient instanceof PDOException){
                            echo $listRdvInPatient->getMessage();                                                        
                        }else {
                            foreach ($listRdvInPatient as $rdv){
                                echo $rdv->dateHour;                        
                            }
                        }
                        ?>
                    ...
                    <div class="text-danger fst-italic mb-3">
                    <?=htmlentities($errorCreatePatient["rdv"] ?? '');?>
